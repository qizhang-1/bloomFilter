...
class HashType1(object):
    ...
    def __init__(self, config, genHashes):
        ...
        self.k = config['k']
        self.n = config['n']
        self.n = util.findNextPrime(self.n)
...
class HashType2(object):
    ...
    def getHashList(self, x):
        ...
        Returns list of k hashes of this element
        """
        #res = [((self.a[i] * x + self.b[i]) % self.N) % self.n for i in range(self.k)]
        #your code goes here

        return [((self.a[i] * x + self.b[i]) % self.N) % self.n for i in range(self.k)]
...
class BloomFilter(object):     
    ...
    def __init__(self, config):
        ...
        #your code goes here
        self.n = util.findNextPrime(config['n'])
        self.slots = [False] * self.n
    ...
    def add(self, x):
        ...
        #your code goes here
        #bin_list = self.hashFunc.getHashList(x)
        for i in self.hashFunc.getHashList(x):
            self.slots[i] = True
    ...
    def contains(self, x):
        ...
        #your code goes here
        return all(self.slots[i] for i in self.hashFunc.getHashList(x))
